...
def flatten_record_for_hf(record: Dict[str, Any]) -> Dict[str, Any]:
    return {
        ...
        "pre_correction_features_json": json_string(record.get("pre_correction_features")),
        "post_correction_features_json": json_string(record.get("post_correction_features")),
...
def main() -> None:
    ...
    existing_records_count = count_jsonl_records(args.output_jsonl) if args.resume else 0
